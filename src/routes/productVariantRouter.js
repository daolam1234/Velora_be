...
import { handleVariantImages, uploadVariantImages } from "../middlewares/uploadVariant.js";
...
productVariantRouter.post("/", uploadVariantImages, handleVariantImages, createVariant);
productVariantRouter.put("/:id", uploadVariantImages, handleVariantImages, updateVariant);
